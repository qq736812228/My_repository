...
public class AdminOperationLogController {
    ...
    public AdminOperationLogController(OperationLogRepository repository) {
    ...
    @PostMapping
    @OperationAudit(module = "操作日志", action = "新增")
    public ApiResponse<OperationLog> create(@RequestBody OperationLog body) {
        return ApiResponse.ok(repository.save(body));
    }

    @PutMapping("/{id}")
    @OperationAudit(module = "操作日志", action = "修改")
    public ApiResponse<OperationLog> update(@PathVariable Long id, @RequestBody OperationLog body) {
    ...
    @DeleteMapping("/{id}")
    @OperationAudit(module = "操作日志", action = "删除")
