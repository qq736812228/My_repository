...
public class AdminSysMenuController {
    ...
    public AdminSysMenuController(SysMenuRepository repository) {
    ...
    @DeleteMapping("/{id}")
    @OperationAudit(module = "菜单管理", action = "删除")
